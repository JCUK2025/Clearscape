...
function renderReminders() {
    ...
    sortedReminders.forEach((reminder, index) => {
        ...
        li.innerHTML = `<span>${reminder.date}: ${reminder.text}</span><button data-index="${index}">Delete</button>`;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('analyticsYearSelect').addEventListener('change', () => renderAnalyticsPage(true));
    ...
    document.getElementById('exportDataBtn').addEventListener('click', () => {
        const dataToExport = {
            ...
            settings: {
                ...
                lastExpenseNumber: localStorage.getItem('lastExpenseNumber')
            }
        };
