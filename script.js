...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('goToAnalyticsFromDashboardBtn').addEventListener('click', () => { renderAnalyticsPage(); showView('analyticsView'); });
    ...
    document.getElementById('transactionForm').addEventListener('submit', function(e) {
        ...
        if (!transactionData.date || !transactionData.name || !transactionData.amountDue === 0) return alert('Please fill out Date, Name, and Amount Due.');
    ...
    function populateSettingsPage() { document.getElementById('businessNameSetting').value = localStorage.getItem('businessName') || 'ClearScape'; }
