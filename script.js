...
function processDataForYear(year) {
    const monthlySales = Array(12).fill(0), monthlyExpenses = Array(12).fill(0);
    transactions.forEach(t => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('goToInsightsBtn').addEventListener('click', () => { if (initApp()) { renderAnalyticsPage(); showView('analyticsView'); } });
    ...
    document.getElementById('updatePasswordBtn').addEventListener('click', () => {
        const newPassword = document.getElementById('updatePasswordInput').value;
