...
// Inactivity timer: return to splash after 5 minutes
let inactivityTimer;
...
function renderHistory() {
  ...
  transactions.slice().reverse().forEach((t, i) => {
    ...
    div.innerHTML = `
      ...
      <br><button onclick="editTransaction(${transactions.length - 1 - i})">✏️ Edit</button>
      <button onclick="deleteTransaction(${transactions.length - 1 - i})">🗑️ Delete</button>
    `;
...
// Update help box with reminders and outstanding balances
