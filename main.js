...
function updateDashboard() {
  ...
  let monthlySales = 0, monthlyExpenses = 0;
  ...
  if (netBalanceEl) netBalanceEl.textContent = (totalSales - totalExpenses).toFixed(2);
  ...
  if (monthlyNetEl) monthlyNetEl.textContent = (monthlySales - monthlyExpenses).toFixed(2);
}
