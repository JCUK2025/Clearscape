...
function updateDashboard() {
  ...
  transactions.forEach(t => {
    ...
    const isIncome = [
      "Landscaping", "Lawn Maintenance", "Hedge trimming/Care",
      "Tree Surgery/Felling", "Fencing", "Contract work", "Other"
    ].includes(t.type);

    const isExpense = [
      "Fuel", "Wages", "Utilities", "Insurance",
      "Rent", "Materials", "Equipment"
    ].includes(t.type);
