...
function updateDashboard() {
  let sales = 0, expenses = 0, deposits = 0, outstanding = 0, refundTotal = 0;
  ...
  document.getElementById("salesTotal").style.color = refundTotal > 0 ? "red" : "#2e5d2e";
...
function updateFormFields() {
  ...
  if (type === "Sale") {
    options = ["Lawn maintenance", "Hedge Maintenance", "Landscaping", "Fencing", "Tree Surgery/Felling"];
  } else if (type === "Expense") {
    options = ["Wages", "Utilities", "Services", "Fuel", "Materials", "Equipment", "Clothing/Safety Equipment", "Petty cash", "Other"];
  } else if (type === "Deposit") {
    options = ["Loan", "Cash injection", "Refund from supplier"];
  } else if (type === "Refund") {
    options = ["Good will gesture", "Cancellation of job", "Other"];
  } else {
...
// Dynamic hint for part payments and splash logic
