...
function updateDashboard() {
  ...
  transactions.forEach(t => {
    ...
    const isIncome = ["Landscaping", "Lawn Maintenance", "Hedge trimming/Care", "Tree Surgery/Felling", "Fencing", "Contract work", "Other"].includes(t.type);
    const isExpense = ["Fuel", "Wages", "Utilities", "Insurance", "Rent", "Materials", "Equipment"].includes(t.type);
  ...
  document.getElementById("balance").style.color = balance < 0 ? "red" : "#2e5d2e";
}
...
function updateHelpBox() {
  ...
  const outstandingClients = transactions.filter(t =>
    ...
    ["Landscaping", "Lawn Maintenance", "Hedge trimming/Care", "Tree Surgery/Felling", "Fencing", "Contract work", "Other"].includes(t.type)
  );
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (editIndex !== null && typeof editTransaction === "function") {
